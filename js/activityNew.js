...
cola(function(model){
	...
	model.set("selectValue", "Y");//下拉框中点选的值
...
//页面上面统计数据的接口
            ...
            $('#ArbetTable').bootstrapTable({
				...
				for(var i=0;i<mydata.length;i++){
                    ...
                    return {
                        // "total": res.total,//总页数
                        // "rows": res.rows   //数据
						 "total": res.resultObject.pageCount,//总页数
						"rows": mydata   //数据
                    };
                },
                columns: [
    ...
    //             },
        ...
        oTableInit.queryParams = function (params) {
            ...
            model.set("num",num);
			console.log(model.get("selectValue"));
            // var temp = {
            ...
            // };   
			var temp = {
				ctype:localStorage.getItem("ctype"),
				pageIndex:num,//第几页 
				pageSize:"10",//每页多少
				cname:model.get("itemValue"),//搜索的名字
				attendType:model.get("selectValue")//o 下拉框  Y 和 N
			};
