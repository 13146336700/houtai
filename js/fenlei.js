...
cola(function(model) {
	$(".fl").on("click", "div", function(event) {
		var target = $(event.target);
		target.css("border", "1px solid #1C90F3").css("color", "#1C90F3").siblings().css("border", "1px solid #cccccc").css("color", "#666666");
		model.set("fld", target.html());
	});
  ...
  layui.use('laydate', function(){
	...
	// console.log(model.get("fld"))
	if(model.get("fld")==undefined){
		model.set("fld","产品票/礼品册")
	}
